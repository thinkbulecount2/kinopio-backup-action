...
module.exports = function(charset) {
  try {
    if (!iconv) iconv = __nccwpck_require__(4397);
  } catch(e) {
    /* iconv not found */
  }
...
var fs          = __nccwpck_require__(5747),
    ...
    stream      = __nccwpck_require__(2413),
    debug       = __nccwpck_require__(5062)('needle'),
    stringify   = __nccwpck_require__(8258)/* .build */ .J,
    multipart   = __nccwpck_require__(8116),
    auth        = __nccwpck_require__(8248),
    cookies     = __nccwpck_require__(393),
    parsers     = __nccwpck_require__(3078),
    decoder     = __nccwpck_require__(394);
